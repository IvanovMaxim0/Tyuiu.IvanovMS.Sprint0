using Tyuiu.IvanovMS.Sprint0.Task7.V0.Lib;
class program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("* одиночных массивов по длинне.                                           *");
        Console.WriteLine("*                                                                         *");
        Console.WriteLine("***************************************************************************");
        ...
        {
            Console.WriteLine("Ошибка! Исходные массивы имеют разное количествр элементов");
        }
